...
const config = {
  "generator": {
    ...
    "output": {
      "value": "C:\\Users\\user\\Desktop\\BP TICKET\\bp-ticket-internship-backend\\src\\generated\\prisma",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "C:\\Users\\user\\Desktop\\BP TICKET\\bp-ticket-internship-backend\\prisma\\schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        ...
        "value": "postgresql://postgres:password@localhost:5432/BP-TICKETS-DB?schema=public"
      }
    }
  },
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"../src/generated/prisma\"\n}\n\ndatasource db {\n  provider = \"postgresql\"\n  url      = env(\"DATABASE_URL\")\n}\n\nmodel User {\n  id        String   @id @default(uuid())\n  firstName String\n  lastName  String\n  email     String   @unique\n  password  String\n  CreatedAt DateTime @default(now())\n  updatedAt DateTime @updatedAt\n}\n",
  "inlineSchemaHash": "f30ce2da3f13849a8e8f4767d8d735d7b91d0e9563a7036db44f6f850897cde1",
  "copyEngine": true
}
